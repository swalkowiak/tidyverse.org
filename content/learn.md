...
(_Do you have a course you'd like to see listed here? Please submit a [pull request](https://github.com/tidyverse/tidyverse.org/edit/master/content/learn.md)!_)
  ...
  * [Applied Data Science in R](https://www.mindproject.io/product-category/general-training-courses/) by Mind Project - London (UK), Brussels (Belgium), Barcelona (Spain) and Berlin (Germany). The 3-day open-to-public training courses "Applied Data Science in R" run in different locations in Europe, cover modern approaches in data analysis using R language and its rich ecosystem of external libraries including tidyverse family of packages e.g. dplyr, ggplot2, tidyr, readr, tibble and other essential R libraries e.g. data.table, lubridate, Hmisc, readxl, haven etc. 
